...
namespace KontGeld.DataSet1TableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Login] ([Login], [Senha]) VALUES (@Login, @Senha);\r\nSELECT Id," +
                " Login, Senha FROM Login WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Login] SET [Login] = @Login, [Senha] = @Senha WHERE (([Id] = @Origi" +
                "nal_Id) AND ([Login] = @Original_Login) AND ([Senha] = @Original_Senha));\r\nSELEC" +
                "T Id, Login, Senha FROM Login WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::KontGeld.Properties.Settings.Default.TesteConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Login, Senha FROM dbo.Login";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        Id, Login, Senha\r\nFROM            Login\r\nWHERE        (Id = @Id)";
        ...
        public virtual int FillBy(DataSet1.LoginDataTable dataTable, int Id) {
        ...
        public virtual DataSet1.LoginDataTable GetDataBy(int Id) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(Id));
            DataSet1.LoginDataTable dataTable = new DataSet1.LoginDataTable();
            this.Adapter.Fill(dataTable);
